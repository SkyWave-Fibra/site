...
<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true" class="app-default">
	...
	<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
		...
		<!--MENU: INICIO DE FINANCEIRO-->
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" data-kt-menu-offset="22,0" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
									<span class="menu-link">
										<span class="menu-icon">
											<i class="ki-duotone ki-parcel-tracking .fs-5tx">
						...
						<!--SUBMENU: INICIO DE CLIENTES-->
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
											<span class="menu-link">
												<span class="menu-icon">		
													<i class="ki-solid ki-profile-user text-dark fs-1">
														<span class="path1"></span>
														<span class="path2"></span>
														<span class="path3"></span>
											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
												...
												<div class="menu-item">
													<a class="menu-link" href="apps/projects/list.html">
														...
														<span class="menu-title">Cadastar clientes</span>
													</a>
													</div>
													<!--SUBMENU: GERENCIAR CLIENTES-->
												<div class="menu-item">
													<a class="menu-link" href="apps/projects/project.html">
														...
														<span class="menu-title">Gerenciar clientes</span>
													</a>
													</div>
													<!--SUBMENU: GERENCIAR CONTRATOS-->
													<div class="menu-item">
													<a class="menu-link" href="apps/projects/list.html">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
									...
									<!--SUBMENU: FIM DE CLIENTES-->
								<!--SUBMENU: INICIO DE PLANOS-->
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
											<span class="menu-link">
												<span class="menu-icon">
													<i class="ki-solid ki-wifi text-dark fs-1">
														<span class="path1"></span>
														<span class="path2"></span>
														<span class="path3"></span>
														<span class="path4"></span>
											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
												<div class="menu-item">
													<a class="menu-link" href="apps/projects/list.html">
														...
														<span class="menu-title">Cadastar planos</span>
													</a>
													</div>
												<div class="menu-item">
													<a class="menu-link" href="apps/projects/project.html">
														...
														<span class="menu-title">Gerenciar planos</span>
													</a>
													</div>
												</div>
											</div>
									<!--SUBMENU: FIM DE PLANOS-->
									<!--SUBMENU: INICIO DE FUNCIONARIOS-->
											<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
											<span class="menu-link">
												<span class="menu-icon">
													<i class="ki-duotone ki-courier fs-1 text-dark">
														<span class="path1"></span>
														<span class="path2"></span>
														<span class="path3"></span>
													</i>
											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
												<div class="menu-item">
													<a class="menu-link" href="apps/projects/list.html">
														...
														<span class="menu-title">Cadastar funcionarios</span>
													</a>
													</div>
												<div class="menu-item">
													<a class="menu-link" href="apps/projects/project.html">
														...
														<span class="menu-title">Gerenciar funcionarios</span>
													</a>
													</div>
												</div>
											</div>
								<!--SUBMENU: FIM DE FUNCIONARIOS-->
								<!--SUBMENU: INICIO DE EQUIPAMENTOS-->		
										<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
											<span class="menu-link">
												<span class="menu-icon">
													<i class="ki-solid ki-router text-dark fs-1">
														<span class="path1"></span>
														<span class="path2"></span>
													</i>
												</span>
											...
											<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
												<div class="menu-item">
													<a class="menu-link" href="apps/ecommerce/catalog/products.html">
														...
														<span class="menu-title">Cadastrar Equipamentos</span>
													</a>
													</div>
												<div class="menu-item">
													<a class="menu-link" href="apps/ecommerce/catalog/categories.html">
														...
														<span class="menu-title">Gerenciar Equipamentos</span>
													</a>
													</div>
												</div>
											</div>
										</div>
									<!--SUBMENU: FIM DE EQUIPAMENTOS-->
									</div>
		<!--MENU: FIM DO MENU FINANCEIRO-->

		<!--MENU: INICIO DE CLEINTES-->
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" data-kt-menu-offset="22,0" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
									<span class="menu-link">
										<span class="menu-icon">
										...
										<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
											...
											<div class="menu-item">
												...
												<a class="menu-link" href="https://preview.keenthemes.com/html/metronic/docs/getting-started/changelog" target="_blank">
													...
													<span class="menu-title">Changelog v8.3.2</span>
												</a>
												<!--end:Menu link-->
											</div>
											<!--end:Menu item-->
					...
					<div class="app-main flex-column flex-row-fluid" id="kt_app_main">
						...
						<div id="kt_app_footer" class="app-footer d-flex flex-column flex-md-row flex-center flex-md-stack pb-3">
							...
							<div class="text-gray-900 order-2 order-md-1">
								...
								<a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">GTI UNIAENE | 6º Período</a>
							</div>
							<!--end::Copyright-->
							<!--begin::Menu-->
							<ul class="menu menu-gray-600 menu-hover-primary fw-semibold order-1">
								<li class="menu-item">
									<a href="<?= url("shared/themes/metronic") ?>" target="_blank" class="menu-link px-2">Consultar Tema</a>
								</li>
								<li class="menu-item">
									<a href="<?= url() ?>" target="_blank" class="menu-link px-2">Sobre Nós</a>
								</li>
								<li class="menu-item">
									<a href="<?= url() ?>" target="_blank" class="menu-link px-2">Suporte</a>
								</li>
							</ul>
							<!--end::Menu-->
						</div>
