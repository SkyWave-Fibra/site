...
<div class="card">
    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title">
            <!--begin::Search-->
            <form action="<?= url("/app/chamados/historico"); ?>" method="post" class="d-flex align-items-center position-relative my-1">
            ...
            <?php if (!empty($search)): ?>
                <a href="<?= url('/app/chamados/historico?clear=1'); ?>" class="btn btn-light ms-3">
            ...
            <div class="d-flex justify-content-end gap-2" data-kt-user-table-toolbar="base">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu p-5" style="min-width: 300px;">
                        <form action="<?= url("/app/chamados/historico"); ?>" method="get">
                            <div class="mb-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($ticket->closed_at): ?>
                                        <?= date_fmt($ticket->closed_at, "d/m/Y H:i"); ?>
                                    <?php else: ?>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <a class="dropdown-item" href="<?= url("/app/chamado/{$ticket->id}"); ?>">
                                                    <i class="ki-outline ki-eye fs-5 me-2"></i>Visualizar
                                                </a>
                                            </li>
                                            <?php if ($ticket->status === 'resolved'): ?>
                                                <li><hr class="dropdown-divider"></li>
                                                <li>
                                                    <a class="dropdown-item" href="javascript:void(0)" onclick="reopenTicket(<?= $ticket->id; ?>)">
                                                        <i class="ki-outline ki-arrow-circle-left fs-5 me-2"></i>Reabrir Chamado
                                                    </a>
                                                </li>
                                            <?php endif; ?>
                                            <li><hr class="dropdown-divider"></li>
                ...
                <ul class="pagination justify-content-end">
                    <?php for ($i = 1; $i <= $pages; $i++): ?>
                        <li class="page-item <?= $i == $page ? 'active' : ''; ?>">
                            <a class="page-link" href="<?= url("/app/chamados/historico/{$i}/{$limit}"); ?>">
                                <?= $i; ?>
                            </a>
                        </li>
                    <?php endfor; ?>
...
<script>
    ...
    document.getElementById('ticketLimit').addEventListener('change', function() {
        ...
        window.location.href = "<?= url('/app/chamados/historico'); ?>/1/" + limit;
    });
    ...
    function reopenTicket(id) {
        Swal.fire({
            ...
            text: 'Deseja reabrir este chamado?',
            icon: 'question',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                ...
                .then(data => {
                    if (data.redirect) {
                        Swal.fire({
                            title: 'Sucesso!',
                            text: 'Chamado reaberto com sucesso!',
                            icon: 'success',
                            timer: 2000,
                        ...
                        let text = 'Chamado reaberto com sucesso!';
                        ...
                        Swal.fire({
                            ...
                            if (icon === 'success') {
                                window.location.href = "<?= url('/app/chamados'); ?>";
                            }
                        });
                    }
                })
