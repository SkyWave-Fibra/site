...
<div class="card shadow-sm mb-10">
    <div class="card-header border-0 pt-8 pb-4">
        <h3 class="card-title fw-bolder fs-1">Concluir Upgrade</h3>
        <p class="text-muted mt-2">Revise os detalhes antes de finalizar o upgrade do seu plano.</p>
    </div>
    ...
    <div class="card-body pt-0">
        ...
        <div class="alert alert-info d-flex align-items-center p-6 rounded-3 mb-10 shadow-sm">
            ...
            <div>
                ...
                <p class="mb-0">Este pagamento é fictício e simula um checkout real para upgrade de plano.</p>
            </div>
        </div>
                ...
                <div class="card shadow-sm border-0 rounded-3">
                    <div class="card-body p-5">
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <i class="ki-outline ki-abstract-26 fs-2hx text-primary me-3"></i>
                            <h4 class="fw-bolder m-0">Resumo do Upgrade</h4>
                        </div>

                        <div class="mb-4">
                            <span class="text-muted">Novo plano escolhido</span>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-5">
                            <span class="fs-3 fw-bolder text-dark">Valor Inicial:</span>
